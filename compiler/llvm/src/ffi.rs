use {
    super::RustString,
    libc::{c_char, c_int, c_uint, c_ulonglong, c_void, size_t},
...
pub mod debuginfo {
    use {
        super::{InvariantOpaque, Metadata},
        bitflags::bitflags,
    };
...
extern "C" {
    ...
    // DEBUG INFO IS NOT INTERESTING FOR US FOR NOW
    ...
    // This function makes copies of pointed to data,
    // so the data's lifetime may end after this function returns
